...
const WalletScreen = () => {
  ...
  useEffect(() => {
    ...
    console.log(articleId,"the article id is ");
  }, []);
      ...
      <div className={classes["wallets-container"]}>
        ...
        <div className={classes["amounts"]}>
          <div className={classes["amounts-first-row"]}>
            <p
              className={`${classes["amounts-100"]} ${
                selectedAmount === 100 ? classes["selected"] : ""
              }`}
              onClick={() => {
            ...
            <p
              className={`${classes["amounts-200"]} ${
                selectedAmount === 200 ? classes["selected"] : ""
              }`}
              onClick={() => {
          ...
          <div className={classes["amounts-second-row"]}>
            <p
              className={`${classes["amounts-500"]} ${
                selectedAmount === 500 ? classes["selected"] : ""
              }`}
              onClick={() => {
            ...
            <p
              className={`${classes["amounts-other"]} ${
                showInput ? classes["selected"] : ""
              }`}
