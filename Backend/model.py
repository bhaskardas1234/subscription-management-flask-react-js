...
# # #     def __init__(self,name,email,phonenumber,token,sessionid,fingerprint,status):
# # #         self.name=name
# # #         self.email=email
...
# class USER(db.Model):
#     __tablename__="MBI_USER_INFO_V2"
#     id=db.Column(db.Integer,primary_key=True,autoincrement = True)
#     name=db.Column(db.TEXT)
#     email=db.Column(db.TEXT)
#     phone_number=db.Column(db.TEXT)
...
#     def __init__(self,name,email,phone_number, dob, gender, token,sessions,active_sessions):
#         self.name=name
#         self.email=email
#         self.phone_number=phone_number
#         self.dob = dob
