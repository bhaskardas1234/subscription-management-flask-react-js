    ...
    try:
        ...
        for i, user_id in enumerate(child_account_ids):
            ...
            new_user_subscription = USER_SUBSCRIPTION(
                ...
                content_detatils=base_user_sub.content_details
            )
...
#         # Create the subscription details object
#         user_subscription_details = USER_SUBSCRIPTION(
#             user_id=user_id,
#             start_day=start_day,
#             end_day=end_day,
#             s_id=s_id,
...
#         # Add the subscription details to the session and commit
#         db.session.add(user_subscription_details)
#         db.session.commit()

#         print("user_subscription_details stored successfully")
#         return {"success": "user_subscription_details stored successfully"}

#     except Exception as e:
#         print(f"Error occurred: {str(e)}")
#         return {"error": f"internal server error, user_subscription_details not stored successfully,{str(e)}"}




#main save_user_subscription_details
